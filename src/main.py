...
from utils.criar_backup import criar_backup
...
class BemStockApp(ctk.CTk):
    ...
    def mostrar_primeiro_acesso(self, usuario):
        ...
        self.frame_atual = PrimeiroAcessoView(
            self,
            usuario
        )
    ...
    def mostrar_dashboard(self, usuario):
        ...
        self.frame_atual = DashboardView(
            self,
            usuario
        )
    ...
    def mostrar_cadastro_produto(
        ...
        self.frame_atual = CadastroProdutoView(
            self,
            usuario,
            produto
        )
    ...
    def mostrar_movimentacao(self, usuario):
        ...
        self.frame_atual = MovimentacaoView(
            self,
            usuario
        )
    ...
    # ==================================================
    def mostrar_cadastro_movimentacao(
        self,
        usuario,
        movimentacao=None
    ):
        ...
        self.title(
            "BemStock - Cadastro de Movimentação"
        )

        self.frame_atual = CadastroMovimentacaoView(
            self,
            usuario,
            movimentacao
        )
    ...
    def mostrar_cadastro_usuario(
        ...
        self.title(
            "BemStock - Cadastro de Usuário"
        )

        self.frame_atual = CadastroUsuarioView(
            self,
            usuario,
            usuario_edicao
        )
...
def main():
    ...
    try:
        ...
        print(f"Erro ao iniciar sistema: {erro}")
